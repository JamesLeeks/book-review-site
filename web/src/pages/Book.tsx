...
export function Book() {
    ...
    return <>
        <div className="banner"><button onClick={() => setTheme(theme === "dark" ? "light" : "dark")}>change theme</button></div>

        <div className={`page ${theme}`}>

            <div className="cover-info-container">
                <div className="cover-info">
                    <img className="cover" src={placeHolderCover} alt="Book cover" />
            ...
            <div className="stats-container">
                <div className="stats">
                    ...
                    <div className="divider"></div>
                    <div className="pie-chart-container"> <PieChart size={useWindowDimensions().width / 5} data={[8, 7, 6, 6, 5]} colorScheme={{backgroundColour: colourScheme.backgroundColour, strokeColour: colourScheme.strokeColour}} /></div>
                    <div className="divider"></div>
